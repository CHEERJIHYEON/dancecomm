...
const navigation = [
  ...
  { name: "MyPage", href: "/mypage", icon: UsersIcon, current: false },
  { name: "Board", href: "/board", icon: FolderIcon, current: false },
  ...
  { name: "Contact", href: "/contact", icon: ChartPieIcon, current: false },
];
const teams = [
            ...
            <Routes>
              <Route
                ...
                element={
                  <Fragment>
                    <div className="title">
                      <h2 className="titleDetails text-3xl font-bold ">
                        댄스맵
                      </h2>
                    </div>
                    <MapContainer />
